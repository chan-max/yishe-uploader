...
import { getOrCreateBrowser, setupAntiDetection } from '../services/BrowserService.js';
...
export async function publishToXiaohongshu(publishInfo) {
  try {
    ...
    await page.goto(SOCIAL_MEDIA_UPLOAD_URLS.xiaohongshu_pic, { waitUntil: 'networkidle2' });
